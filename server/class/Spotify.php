...
class Spotify
{
    ...
    public function tryLogin($username, $password)
    {
        ...
        curl_setopt(
            $this->ch,
            CURLOPT_POSTFIELDS,
            "remember=false&username=$username&password=$password&csrf_token=$token&continue=https%3A%2F%2Fopen.spotify.com%2F"
        );
    ...
    public function followUser($token, $ids)
    {
        ...
        curl_setopt(
            $this->ch,
            CURLOPT_URL,
            "https://api.spotify.com/v1/me/following?type=user&ids=" . $ids
        );
    ...
    public function followArtist($token, $ids)
    {
        ...
        curl_setopt(
            $this->ch,
            CURLOPT_URL,
            "https://api.spotify.com/v1/me/following?type=artist&ids=" . $ids
        );
        curl_setopt($this->ch, CURLOPT_POSTFIELDS, "");
        curl_setopt($this->ch, CURLOPT_POST, 1);
        curl_setopt($this->ch, CURLOPT_CUSTOMREQUEST, "PUT");
